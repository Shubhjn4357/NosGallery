...
class NOSFolderWidget : NosBaseWidgetProvider() {
    ...
    override fun onUpdateWidget(
        ...
        val title = customs?.optString("titleText") ?: "APPS FOLDER"
        container.addView(R.id.dynamic_view_container, createHeader(context, title, "home", accentColor, subtextColor))
        
        container.addView(R.id.dynamic_view_container, createTextView(context, "Folder Open", 16f, textColor, marginTop = 6f))
        ...
        val footer = customs?.optString("footerText") ?: "NOS • APPS"
