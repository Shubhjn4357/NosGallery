...
class NOSClockDigitalWidget : NosBaseWidgetProvider() {
    ...
    override fun onUpdateWidget(
        ...
        val title = customs?.optString("titleText") ?: "DIGITAL CLOCK"
        container.addView(R.id.dynamic_view_container, createHeader(context, title, "clock", accentColor, subtextColor))
        container.addView(R.id.dynamic_view_container, createClockView(context, "h:mm a", 24f, textColor, marginTop = 6f))
