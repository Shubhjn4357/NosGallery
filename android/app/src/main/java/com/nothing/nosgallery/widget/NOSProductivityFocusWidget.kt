...
class NOSProductivityFocusWidget : NosBaseWidgetProvider() {
    ...
    override fun onUpdateWidget(
        ...
        container.addView(R.id.dynamic_view_container, createButtonView(context, "START FOCUS", "toggle_focus", appWidgetId, textColor, btnBg))
