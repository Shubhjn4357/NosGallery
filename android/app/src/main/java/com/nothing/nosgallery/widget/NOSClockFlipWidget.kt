...
class NOSClockFlipWidget : NosBaseWidgetProvider() {
    ...
    override fun onUpdateWidget(
        ...
        val title = customs?.optString("titleText") ?: "FLIP CLOCK"
        container.addView(R.id.dynamic_view_container, createHeader(context, title, "clock", accentColor, subtextColor))
        container.addView(R.id.dynamic_view_container, createClockView(context, "HH:mm", 26f, textColor, marginTop = 6f))
        
        val sub = customs?.optString("subValueText") ?: "RETRO SHUTTER"
